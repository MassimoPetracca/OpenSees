...
extern void* OPS_ASDPlasticDamageConcrete3DMaterial(void);
extern void* OPS_ASDSteel3DMaterial(void);
#ifdef _EIGEN3
...
/////////////////////////////////////////////////////////////////
  ...
  // PressureDependMultiYield03 (based on PressureDependMultiYield02). 
	...
	else if(strcmp(argv[1], "TIMSoilAbutment3D") == 0) {
		void *theMat = OPS_TIMSoilAbutment3D();
		if (theMat != 0)  {
			theMaterial = (NDMaterial *)theMat;
		}
		else 
	...
	else if(strcmp(argv[1], "ASDPlasticDamageConcrete3D") == 0) {
		void *theMat = OPS_ASDPlasticDamageConcrete3DMaterial();
		if (theMat != 0)  {
			theMaterial = (NDMaterial *)theMat;
		}
		else
	...
	else if(strcmp(argv[1], "ASDSteel3D") == 0) {
		void *theMat = OPS_ASDSteel3DMaterial();
		if (theMat != 0)  {
			theMaterial = (NDMaterial *)theMat;
		}
		else
