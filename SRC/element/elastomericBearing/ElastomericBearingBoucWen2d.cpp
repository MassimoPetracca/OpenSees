...
void ElastomericBearingBoucWen2d::captureInitialDisp(void)
{
    const Vector &dsp1 = theNodes[0]->getTrialDisp();
    const Vector &dsp2 = theNodes[1]->getTrialDisp();
    for (int i=0; i<3; i++)  {
...
void ElastomericBearingBoucWen2d::onActivate(void)
{
...
void ElastomericBearingBoucWen2d::onDeactivate(void)
{
}
